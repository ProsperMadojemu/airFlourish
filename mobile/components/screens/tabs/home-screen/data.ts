...
type RoutePath =
  | "/(protected)/(tabs)/flights"
  | "/(protected)/hotels/search"
  | "/(protected)/transport"
  | "/(protected)/visa";
...
export type QuickAction = {
  id: string;
  label: string;
  href: RoutePath | ExternalPathString | RelativePathString;
...
export const QUICK_ACTIONS: QuickAction[] = [
  {
    ...
    href: "/(protected)/(tabs)/flights",
  },
  {
    id: "hotels",
    label: "Hotels",
    icon: "business-outline",
    href: "/(protected)/hotels/search",
  },
  {
    id: "transport",
    label: "Transport",
    icon: "car-outline",
    href: "/(protected)/transport",
  },
  {
    id: "visa",
    label: "Visa",
