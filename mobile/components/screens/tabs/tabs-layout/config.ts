...
export const TAB_SCREENS = [
  ...
  { name: 'bookings/index', title: 'Bookings', icon: 'receipt-outline', activeIcon: 'receipt', label: 'Bookings' },
  { name: 'flights/index', title: 'Flights', icon: 'airplane-outline', activeIcon: 'airplane', label: 'Flights' },
